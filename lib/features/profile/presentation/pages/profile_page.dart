          ...
          Positioned(
            ...
            child: Container(
              decoration: const BoxDecoration(
                color: Colors.white, // Or Color(0xFFF9FAFB) if you prefer grey
                  ...
                  children: [
                    ...
                    _buildInfoCard(
                      children: [
                        ...
                        _buildReadOnlyField('NIK', '35082128010001'),
                        const SizedBox(height: 16),
                        _buildReadOnlyField(
                          'Alamat',
                    ...
                    _buildInfoCard(
                      children: [
                        _buildReadOnlyField('Nomor Hp', '081234567890'),
                        const SizedBox(height: 16),
                        _buildReadOnlyField('Email', 'emailku@email.com'),
                        const SizedBox(height: 16),
